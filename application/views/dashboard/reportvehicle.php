	...
	$(document).ready(function() {
		...
		function getAjaxProject() {
			$.ajax({ //create an ajax request to display.php
				type: "GET",
				url: <?php echo  "'" .  URL  . "Dashboard/VehicleList1'"; ?>,
				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<h6> Remarks/<span class="laotext">ໝາຍເຫດ</span></h6>
							<div class="d-flex text-center">
								...
								margin-right:10px;
								font-size:10px; "> <i class="fas fa-times"></i> Expired & going to Expired/
									<span class="laotext">ໝົດອາຍຸ ແລະ ກຳລັງຈະໝົດອາຍຸ</span></strong>
								<Strong style="
									padding :10px ;
									color:#000;
									width: 200px;
									...
									border: 1px solid #818181;
									margin-right:10px;
									font-size:10px; "><i class="fas fa-check"></i> Healthy/
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<div class="col-md-4">
							...
							<div class="input-group mb-3">
								<select class="form-control" name="transmission" required>
									<option value="Manual">Manual/<span class="laotext">ກະປຸກ</span></option>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="input-group mb-3">
								<select class="form-control" name="fuel" required>
									<option value="BioDiesel">BioDiesel/<span class="laotext">
											ກາຊວນຊີວະພາບ</span></option>
									<option value="Diesel">Diesel/<span class="laotext">ກາຊວນ
										</span></option>
									<option value="Regular">Regular/<span class="laotext">ແອັດຊັງ
										</span> </option>
						...
						<div class="col-md-4">
							Mileage/<span class="laotext">ເລກໄລຍະສະສົມ</span>
							<div class="input-group mb-3">
