...
$(document).ready(function() {
	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."BusinessUnit/LoadCompany'";?>,
	...
	$("#submitins").submit(function(){
			$.ajax({
							type: "POST",
								url:  <?php echo '"'. URL .'"';?> + "BusinessUnit/AddCompany",
							data: $(this).serialize()
							})
							.done(function(data){
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Business Unit List/<span class="laotext">ຫົວໜາວຍທຸລະກິດ</span></h1>
          </div><!-- /.col -->
          <!--  <div class="col-sm-6">
       ...
       <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">ADD NEW BUSINESS UNIT/<span class="laotext">ເພີ່ມຫົວໜ່ວຍທຸລະກິດໃໝ່</span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i class='fa fa-times-circle' style='color: red; font-size: 25px;'></i>
              </button>
            </div>
            <div class="modal-body">
						<b>Business Unit Name/<span class="laotext">ຊື່ຫົວໜ່ວຍທຸລະກິດ</span></b>
						<div class="input-group mb-3">
						  <input type="text" class="form-control" name="dep" required placeholder="Enter Business Unit name">
