...
$(document).ready(function() {
	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."Maintainance/LoadMaintainance'";?>,
	...
	$("#submitins").submit(function(){
			$.ajax({
							type: "POST",
								url:  <?php echo '"'. URL .'"';?> + "Maintainance/AddMaintainance",
							data: $(this).serialize()
							})
							.done(function(data){
       ...
       <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">ADD NEW REQUEST  MAINTENANCE/
			  <span class="laotext">ເພີ່ມຮ້ອງຂໍບຳລຸງຮັກສາໃໝ່</span></h4>
            ...
            <div class="modal-body">
				<div class="row">
						...
						<div class="col-md-6">
						<strong >DATE/
						<span class="laotext">ວັນທີ</span></STRONG>
						</div>
						<div class="col-md-6">
				...
				<div class="row">
						...
						<div class="col-md-6">
						<strong >LOCATION/
						<span class="laotext">ທີ່ຕັ້ງ</span></STRONG>
						</div>
						<div class="col-md-6">
						<strong >AMOUNT/
						<span class="laotext">ລາຄາລວມ</span></STRONG>
						</div>
				...
				<div class="row">
						...
						<div class="col-md-6">
						<strong >PURPOSE/
						<span class="laotext">ຈຸດປະສົງ</span></STRONG>
						</div>
				...
				<hr>
					<div class="row">
						<div class="col-md-12">
								<TextArea rows="5" class="form-control" name="purpose"placeholder="Enter Purpose"  required></TextArea>
						</div>
