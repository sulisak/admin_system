...
$(document).ready(function() {
	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."Category/Loadcategory'";?>,
	...
	$("#submitins").submit(function(){
			$.ajax({
							type: "POST",
								url:  <?php echo '"'. URL .'"';?> + "Category/Addcategory",
							data: $(this).serialize()
							})
							.done(function(data){
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 text-dark">Category List/<span class="laotext">ປະເພດເຄື່ອງໃຊ້</span></h1>
          </div><!-- /.col -->
          <!--  <div class="col-sm-6">
       ...
       <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">ADD NEW CATEGORY/<span class="laotext">ເພີ່ມປະເພດເຄື່ອງໃຊ້</span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i class='fa fa-times-circle' style='color: red; font-size: 25px;'></i>
              </button>
            </div>
            <div class="modal-body">
						<b> CATEGORY Name/<span class="laotext">ຊື່ປະເພດເຄື່ອງໃຊ້</span></b>
