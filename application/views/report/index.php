				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">
								Vehicle Availability/<span class='laotext'>ຄວາມພ້ອມດ້ານພາຫະນະ
								</span>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							...
							<hr>
							<h6> Remarks/
								<span class='laotext'>ໝາຍເຫດ</span>
							</h6>
							<div class="d-flex text-center">
								...
								font-size:10px;
									...
									<span class='laotext'>ຍັງຄ້າງ</span></strong>
								<Strong style="
								padding :10px ;
								color:#000;
								width: 110px;
								...
								"> <i class="fas fa-times"></i> Booked/
									<span class='laotext'>ບັນທຶກ</span></strong>
								<Strong style="
								padding :10px ;
								color:#000;
								width: 200px;
								...
								"><i class="fas fa-check"></i> Available/
									<span class='laotext'>ພ້ອມໃຊ້ງານ</span>
								</strong>
						...
						<div class="col-md-4">
							...
							<div class="input-group mb-3">
								<select class="form-control" name="transmission" required>
									...
									<option value="Automatic">Automatic/<span class='laotext'>ອໍໂຕເມຕິກ</span></option>
								</select>
							</div>
						</div>
						<div class="col-md-4">
