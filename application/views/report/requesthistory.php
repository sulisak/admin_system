	...
	$(document).ready(function() {
		...
		function getAjaxProject() {
			$.ajax({ //create an ajax request to display.php
				type: "GET",
				url: <?php echo  "'" .  URL  . "Report/VehicleHistoryPro'"; ?>,
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">
								Vehicle History/
								<span class="laotext">ປະຫວັດສາດພາຫະນະ </span>
							</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<form method="post" id="senddataform">
								<div class="row">
									<?php $start = date('Y-m-d', (strtotime('-1 day', strtotime($date)))); ?>
									<div class="col-md-4">
										<input type="date" name="startdate" class="form-control" value="<?php echo 	 $start; ?>">
									</div>
									<div class="col-md-4">
										<input type="date" name="enddate" class="form-control" value="<?php echo 	$date; ?>">
									</div>
									<div class="col-md-4">
