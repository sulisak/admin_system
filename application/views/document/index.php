...
$(document).ready(function() {
	...
	$("#user").change(function(){
		...
		$.ajax({
				type: "GET",
				url:  <?php echo '"'. URL .'"';?> + "Document/getuserdata?id=" +  userid,
				data: $(this).serialize()
				}).done(function(data){
					$("#company").html(data);
				}).fail(function() {
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Document In/<span class="laotext">ເອກະສານຂາເຂົ້າ</span></h1>
          </div><!-- /.col -->
          <!--  <div class="col-sm-6">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group mb-3">
						  ...
						  style="background:#fff"  name="document" required value="0">
					...
					<div class="col-md-6">
						<b>Intended Receiver/<span class="laotext">ຜູ້ຮັບໃນເອກະສານ</span></b>
							<div class="input-group mb-3">
