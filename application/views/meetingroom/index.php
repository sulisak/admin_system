...
$(document).ready(function() {
	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."MeetingRoom/loadRoom'";?>,
	...
	$("#submitins").submit(function(){
			$.ajax({
							type: "POST",
								url:  <?php echo '"'. URL .'"';?> + "MeetingRoom/AddRoom",
							data: $(this).serialize()
							})
							.done(function(data){
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Setup Meeting Room/
			<span class="laotext">ຕັ້ງຄ່າຫ້ອງປະຊຸມ</span></h1>
          </div><!-- /.col -->
          <!--  <div class="col-sm-6">
       ...
       <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">ADD NEW MEETING ROOM/
			  <span class="laotext">ເພີ່ມຫ້ອງປະຊຸມໃໝ່</span></h4>
            ...
            <div class="modal-body">
				...
				<div class="row">
						<div class="col-md-6">
						<strong >ROOM NAME/
						<span class="laotext">ຊື່ຫ້ອງປະຊຸມ </span></STRONG>
						</div>
				...
				<div class="row">
						<div class="col-md-12">
							...
							<input type="text"  class="form-control" name="room" placeholder="Enter room name..." required />
				...
				<div class="row">
						<div class="col-md-6">
						<strong >INCLUSIONS/
						<span class="laotext">ອຸປະກອນທີ່ມີໃນຫ້ອງປະຊຸມ </span> </STRONG>
						</div>
				...
				<div class="row">
						<div class="col-md-12">
							<div class="input-group mb-3">
							<textArea class="form-control" name="inc" placeholder="Enter room inclusion..." rows="10" required ></textArea>
