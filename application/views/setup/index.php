...
$(document).ready(function() {
	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."SetupVehicle/VehicleMaker'";?>,
	...
	$("#addmaker").submit(function(){
					...
					$.ajax({
							type: "POST",
								url: <?php echo  "'".  URL  ."SetupVehicle/VehicleMakerAdd'";?>,
							data: $(this).serialize()
							})
							.done(function(data){
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Vehicle Maker/
			<span class="laotext">ຍີ່ຫໍ້ລົດ</span></h1>
          </div><!-- /.col -->
          <!--  <div class="col-sm-6">
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add new Maker/<span class="laotext">ເພີ່ມຍີ່ຫໍ້ໃໝ່</span></h4>
